        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            <li class="with-x" v-if="searchParams.categoryName">
              ...
              <i @click="handleClearQuery">×</i>
            </li>
            <li class="with-x" v-if="searchParams.keyword">
              {{ searchParams.keyword }}
              <i @click="handleClearParams">×</i>
            </li>
        ...
        <div class="details clearfix">
          ...
          <div class="goods-list">
            <ul class="yui3-g">
              <li
                class="yui3-u-1-5"
                v-for="item in store.getters['search/goodsList']"
                :key="item.id"
              >
                <div class="list-wrap">
                  <div class="p-img">
...
onMounted(() => {
  handleSearch();
  delete searchParams.category1Id;
  delete searchParams.category2Id;
  delete searchParams.category3Id;
});
...
const handleSearch = () => {
  store.dispatch("search/getSearchInfo", searchParams);
};
